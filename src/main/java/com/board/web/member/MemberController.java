...
public class MemberController {
     ...
     * @param form 카카오 가입 정보 (kakaoId, 사용자가 입력한 name)
     * @param bindingResult 유효성 검사 결과
    ...
    public String saveKakao(@Validated @ModelAttribute("kakaoJoinForm") KakaoJoinForm form, BindingResult bindingResult) {
        ...
        String kakaoPassword = randomUUID().toString();

        Member member = new Member(kakaoLoginId, form.getName(), kakaoPassword, form.getKakaoId());
